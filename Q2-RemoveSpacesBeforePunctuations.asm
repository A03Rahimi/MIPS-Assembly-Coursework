...
Loop:
lb      $t2, 0($t0)
beq     $t2, $zero, TerminateLoop # keep going until you reach the end of the string, which is demarcated by the null character.
sb      $t2, 0($t1)
addi    $t0, $t0, 1
addi    $t1, $t1, 1
beq     $t2, '!', CheckSpace
...
beq     $t2, ';', CheckSpace
beq     $t2, ':', CheckSpace
beq     $zero, $zero, Loop # keep going until you reach the end of the string,
